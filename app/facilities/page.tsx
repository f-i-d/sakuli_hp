...
const facilities: Facility[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      "ー 漢字、英字（大文字・小文字、記号）ー 連続ﾌﾟﾘﾝﾄ回数 : 範囲1-9999回",
      "ー 連続印刷の感覚 : 0-50000（6mm）ー インクジェット数 : 1-10ドット",
      "ー 印字速度 : 範囲100-50000（回/秒）ー フォントサイズ : 2-12,7mm/2-25.4mm",
      "ー 印刷内容 : 中国語・英語、QRコード、バーコード、シリアルナンバー、ロゴ、日付",
      "ー 速乾インク：黒 ー 印刷制度 : 600dpi",
      "計数充填機（枚葉式計数機）",
      "ー 計数範囲 : 1-500PCS/ボトル",
      "ー #0-3 最大120錠/回",
      "ー 計数盤 : 30,45/60粒×2セット",
      "ヒートシール機（プリントシーラー）",
      "ー シール速度 : 0-13m/min（可変）",
      "ー シール : 13mm",
    ],
  ...
  },
  {
    ...
    specs: [
      "全自動カプセル検査機",
      "ー 白黒内部検査：１台 ー カプセル長検査：１台",
      "ー 内部ドーム検査：１台 ー 外側ドーム検査：１台",
  ...
  },
  {
    ...
    specs: [
       ...
       "ー 包材料巾 140mm巾 160mm巾 180mm巾 ー 角コーン : 50-80mm（片側）",
       "ー ティーバッグ包装機（超音波シール・カット方式）",
       "ー フラットバッグ : 60-90(W)*40 ー 生産能力 : 30-60袋/分",
       "ー ラベル検出 : 光電露出センサー ー 計量ホッパー : ４種混合可",
      ],
